package com.eliszewski.bettersearch.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.eliszewski.bettersearch.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.eliszewski.bettersearch.repository.UserRepository.USERS_BY_EMAIL_CACHE);
