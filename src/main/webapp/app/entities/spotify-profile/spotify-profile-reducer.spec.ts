...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPOTIFYPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPOTIFYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPOTIFYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPOTIFYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPOTIFYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPOTIFYPROFILE actions', async () => {
      const expectedActions = [
        {
