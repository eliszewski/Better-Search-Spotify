...
export const MusicDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="betterSearchSpotifyApp.music.delete.question">
        <Translate contentKey="betterSearchSpotifyApp.music.delete.question" interpolate={{ id: musicEntity.id }}>
