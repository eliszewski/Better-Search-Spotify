...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHPARAMETER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEARCHPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEARCHPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEARCHPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEARCHPARAMETER actions', async () => {
      const expectedActions = [
        {
