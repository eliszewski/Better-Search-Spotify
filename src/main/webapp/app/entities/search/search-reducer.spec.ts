...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './search.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCH_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEARCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEARCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEARCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEARCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEARCH actions', async () => {
      const expectedActions = [
        {
